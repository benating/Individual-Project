...
\begin{figure}[!h]
\centering
\includegraphics[width=0.3\textwidth]{imgs/ibzonesq.png}
\caption{\label{fig:ibzonesq} The irreducible Brillouin zone of the 2d square
    lattice in reciprocal space (purple). Image adapted from
    source.\cite{surfandbulk}}
\end{figure}
...
Therefore for this case of a infinite 2d square lattice, we first find the 
%TODO: Find dispersion relation of 2d square lattice
...
\begin{figure}[!h]
\centering
\includegraphics[width=0.3\textwidth]{imgs/ibzonehex.png}
\caption{\label{fig:ibzonesq} The irreducible Brillouin zone of the 2d
    hexagonal lattice in reciprocal space (purple). Image adapted from
    source.\cite{surfandbulk}}
\end{figure}
