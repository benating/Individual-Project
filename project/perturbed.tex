...
are present in the bandgap and therefore can only propagate along the
interface.
...
give us the same dispersion relation as the unperturbed system? That is
...
Again, as in the hexagonal case, we have a bandgap with two well-defined edge
states inside.
%TODO: what is an edge state?
